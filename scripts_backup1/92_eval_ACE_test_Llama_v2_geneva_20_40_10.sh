...
###
 ...
 # @LastEditTime: 2023-09-19 00:32:00
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --save_dir /home/caizf/projects/ZeroEE/results/test-Llama-2-7b-geneva-20-40-10-epoch10/ \
    --model /home/caizf/projects/ZeroEE/output/Llama-2-7b-geneva-20-40-10/epoch_10/ \
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --valid_file ACE_valid.json \
    --test_file ACE_test.json \
    --save_dir /home/caizf/projects/ZeroEE/results/test-Llama-2-7b-geneva-20-40-10-epoch15/ \
    --model /home/caizf/projects/ZeroEE/output/Llama-2-7b-geneva-20-40-10/epoch_15/ \
    --tokenizer /home/models/Llama-2-7b-hf/ \
    --eval_batch_size 8

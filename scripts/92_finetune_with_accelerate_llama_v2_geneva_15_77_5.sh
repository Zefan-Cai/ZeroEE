...
accelerate launch \
    ...
    --use_slow_tokenizer \
    --train_file /home/caizf/projects/ZeroEE/data_event_number/geneva/GENEVA_train_negatives15_samples5_events77.json \
    --max_seq_length 256 \
    ...
    --weight_decay 0. \
    --num_train_epochs 30 \
    --output_dir /home/caizf/projects/ZeroEE/output/Llama-2-${MODEL_SIZE}-geneva-15-77-5/ \
    --with_tracking \

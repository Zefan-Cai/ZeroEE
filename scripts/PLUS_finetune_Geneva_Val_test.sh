...
FINETUNE_MODEL_PATH="/local1/zefan/output/Llama-2-7b-geneva-20-96-2000/epoch_10/"

OUTPUT_NAME=Llama2_Geneva_15_40_10/
...
METRICS_FILE="/local1/zefan/ZeroEE/open_instruct/compute_score_ace.py"
REPORT_TAGS="ZeroEE"

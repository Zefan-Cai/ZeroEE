...
###
 ...
 # @LastEditTime: 2023-11-25 22:09:16
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --valid_file ACE_valid_v2.json \
    --test_file ACE_test_v2.json \
    --save_dir ${base_dir}/results/GenData_100_1definition_ACEv2/ \
    --model ${base_dir}/output/Llama2_GenData_1definitions_100/epoch_5 \

...
###
 ...
 # @Date: 2024-01-21 17:18:26
 # @LastEditors: JustBluce 972281745@qq.com
 # @LastEditTime: 2024-01-25 17:03:23
 # @FilePath: /ZeroEE/ZeroEE/scripts/PKU_finetune_GenevaData.sh
...
TRAIN_FILE=${base_dir}data/geneva_train_v2_data/GENEVA_train_negatives10_samples${NumSample}_events96_${NumDefinition}definition.jsonl

...
###
 ...
 # @LastEditTime: 2024-01-25 15:44:12
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --save_dir ${base_dir}/results/GenevaDatav2_Samples20_events96_1definition_epoch5_ACE_ACEDefinition/ \
    --model ${base_dir}/output/GenevaDatav2_Samples20_events96_1definition/epoch_5 \

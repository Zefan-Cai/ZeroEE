...
base_dir="/home/aiscuser/ZeroEE/"

generate_data_dir='ZeroEE/data/generated_data_fix_v5.json'
output_dir='data/generated_data'

output_train_filename=train_${event_num}_10definitions_v2_OntologyAblationFalse.json
output_valid_filename='valid_100_1definitions_v2_OntologyAblationFalse.json'

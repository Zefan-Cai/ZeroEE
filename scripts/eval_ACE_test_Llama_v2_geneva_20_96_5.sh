...
###
 ...
 # @LastEditTime: 2023-09-19 01:00:30
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --model /local1/zefan/output/Llama-2-7b-geneva-20-5-96/epoch_10/ \
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --model /local1/zefan/output/Llama-2-7b-geneva-20-5-96/epoch_15/ \
    --tokenizer /local1/zefan/models/Llama-2-7b-hf/ \
    --eval_batch_size 8
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --model /local1/zefan/output/Llama-2-7b-geneva-20-5-96/epoch_19/ \
    --tokenizer /local1/zefan/models/Llama-2-7b-hf/ \
    --eval_batch_size 8

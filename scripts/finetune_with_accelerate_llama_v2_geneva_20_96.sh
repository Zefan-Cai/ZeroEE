...
accelerate launch \
    ...
    --use_slow_tokenizer \
    --train_file /local1/zefan/data_enevt_number/geneva/GENEVA_train_negatives20_samples2000_events96.json \
    --max_seq_length 256 \
    ...
    --weight_decay 0. \
    --num_train_epochs 30 \
    --output_dir /local1/zefan/output/Llama-2-${MODEL_SIZE}-geneva-20-96-2000/ \
    --with_tracking \

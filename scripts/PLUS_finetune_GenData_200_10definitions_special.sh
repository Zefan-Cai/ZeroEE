...
export template=$2
# template=v2_NoDef
# template=v2_NoOntology
export NumEvents=200
###
...
OUTPUT_NAME=NewGenDatav2_${NumEvents}_10definition_${template}/
TRAIN_FILE=${base_dir}data/generated_data/train_${NumEvents}_10definitions_${template}.json

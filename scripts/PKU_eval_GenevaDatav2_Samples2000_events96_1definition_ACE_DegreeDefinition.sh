...
###
 ...
 # @LastEditTime: 2024-01-24 15:13:42
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --save_dir ${base_dir}/results/GenevaDatav2_Samples2000_events96_1definition_ACE_DegreeDefinition/ \
    --model ${base_dir}/output/GenevaDatav2_Samples2000_events96_1definition/epoch_5 \

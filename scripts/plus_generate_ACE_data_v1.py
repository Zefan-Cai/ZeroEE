...
with open('/local1/zefan/ZeroEE/data/ACE_event_definition_DEGREE.json', 'r') as fp:
...
with open(os.path.join(output_dir, f'ACE_valid_v1_trigger.json'), 'w') as fp:
...
with open(os.path.join(output_dir, f'ACE_test_v1_trigger.json'), 'w') as fp:

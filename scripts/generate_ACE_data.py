...
class Data()
    ...
    def __init__(self, args):
        ...
        with open(os.path.join(base_dir, self.args.data_info_dir, 'ACE_event_definition.json'), 'r') as fp:
    ...
    def get_valid_data(self):
        ...
        with open(os.path.join(self.args.output_dir, self.args.output_valid_filename), 'w') as fp:
    ...
    def get_test_data(self):
        ...
        with open(os.path.join(output_dir, self.args.output_test_filename), 'w') as fp:

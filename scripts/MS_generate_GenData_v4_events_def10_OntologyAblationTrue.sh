...
output_train_filename=train_${event_num}_10definitions_v2_OntologyAblationTrue.json
output_valid_filename='valid_100_1definitions_v2_OntologyAblationTrue.json'

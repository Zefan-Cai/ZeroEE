...
accelerate launch \
    ...
    --use_slow_tokenizer \
    --train_file /local1/zefan/data_sample_96/GENEVA_train_negatives15_samples20_events96.json \
    --max_seq_length 256 \
    ...
    --weight_decay 0. \
    --num_train_epochs 20 \
    --output_dir /local1/zefan/output/Llama-2-${MODEL_SIZE}-geneva-15-96-20/ \
    --with_tracking \

...
###
 ...
 # @LastEditTime: 2023-09-19 01:01:35
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --model /local1/zefan/output/Llama-2-7b-geneva-20-596-5/epoch_15/ \
    --tokenizer /local1/zefan/models/Llama-2-7b-hf/ \
    --eval_batch_size 8
...
python -m open_instruct.eval.ace.run_eval \
    ...
    --model /local1/zefan/output/Llama-2-7b-geneva-20-96-5/epoch_19/ \
    --tokenizer /local1/zefan/models/Llama-2-7b-hf/ \
    --eval_batch_size 8

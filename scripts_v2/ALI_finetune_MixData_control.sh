...
TRAIN_FILE=${base_dir}data/mix_data/GENEVA_n10_s2000_e96_6d_v2_GenData_e200_10d_5s_v2.json
VAL_FILE="${base_dir}data/generated_data/valid_100_1definitions_v2.json"
TEST_FILE="${base_dir}data/ACE_v2_textEE/ACE_test_v2_evaluation.json"
